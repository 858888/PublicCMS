...
var iContentH=$(window).height()-$("#navMenu").height()-29;
...
$("#taskbar").css({top:iContentH+$("#navMenu").height()+5,width:$(window).width()});}
...
return this.each(function(){
var $box=$(this);
$box.find("li>a").click(function(){var $a=$(this);
$.post($a.attr("href"),{},function(html){$("#sidebar").find(".accordion").remove().end().append(html).initUI();
...
if(navMenuIndex&&navMenuIndex!=$('#navMenu>li.selected').index()) $('#navMenu>li').eq(navMenuIndex).find('a').click();
...
this._init();
this._scrollCurrent();
this._getTabs().eq(this._currentIndex).attr("url",url).attr("navMenuIndex",$('#navMenu>li.selected').index());}};(function($){
$.fn.extend({
...
width:$this.attr('width')||820,height:$this.attr('height')||500,
